"""Opening Search for Chess - Simulation

Simulate an interactive session of the Opening Search for Chess.
...
class ChessExplorerSimulation:
    """A simulation of the opening search for chess using a Traverser."""
